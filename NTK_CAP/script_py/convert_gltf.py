import subprocess
import os
def run_gltf_converter(src_dir,osim_file_path, mot_file_paths, output=None):
    # Prepare the command with arguments
    temp = os.getcwd()
    os.chdir(src_dir)
    cmd = [
        'python',  # Assuming you're running a Python script
        os.path.join(src_dir,'call.py'),  # Replace this with the actual script name
...
# run_gltf_converter(src_dir,osim_file, mot_files, output_file)
# vtk pygltflib
#pip install vtk
