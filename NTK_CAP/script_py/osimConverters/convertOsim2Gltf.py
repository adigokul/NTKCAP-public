...
def convertOsim2Gltf(osimModelFilePath, geometrySearchPath, motionPaths,outputfile ,options=None) :
  ...
  modelGltf.save(outputfile)
  return modelGltf
# osimModelFilePath=r"C:\Users\MyUser\Desktop\NTKCAP\Patient_data\1006_justin\2024_12_06\2024_12_06_10_51_calculated\1006_justin_1\opensim\Model_Pose2Sim_Halpe26_scaled.osim"
# geometrySearchPath=r"C:\Users\MyUser\Desktop\NTKCAP\NTK_CAP\script_py\osimConverters\Geometry"
# motionPaths=[r"C:\Users\MyUser\Desktop\NTKCAP\Patient_data\1006_justin\2024_12_06\2024_12_06_10_51_calculated\1006_justin_1\opensim\Balancing_for_IK_BODY.mot"]
# outputfile=r"C:\Users\mauricetemp\Desktop\gltf\model.gltf"
# import os
# os.chdir(r'C:\Users\MyUser\Desktop\NTKCAP\NTK_CAP\script_py\osimConverters')
