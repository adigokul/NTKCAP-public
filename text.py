...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        self.video_player = VideoPlayer(self.select_result_cal_rpjvideo_labels)
    ...
    def check_apose_finish(self):
        if not self.apose_rec_evt.is_set():
            ...
            self.record_opened = False
            self.list_widget_patient_id_record.setSelectionMode(QListWidget.SingleSelection)
    ...
    def Apose_record(self):
        ...
        self.list_widget_patient_id_record.setSelectionMode(QListWidget.NoSelection)
        self.record_enter_task_name.setEnabled(False)
    ...
    def result_load_folders(self):        
        if self.result_select_depth == 0:   
            ...
            self.select_result_cal_task(os.path.join(self.patient_path, self.result_select_patient_id, self.result_select_date, self.result_select_cal_time, self.result_select_task))
    ...
    def select_result_cal_task(self, path):
        self.show_result_path = path
